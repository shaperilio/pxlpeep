...
# Project:  pxlpeep.pro
# Template: app
# Command: C:\Qt\5.5\mingw492_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile pxlpeep.pro
#############################################################################
...
Makefile: pxlpeep.pro C:/Qt/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
